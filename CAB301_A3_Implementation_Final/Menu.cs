            ...
            try
            {
                switch (choice)
                {
                    case 1:
                        ...
                        string filePath = Path.Combine(currentDirectory, "Tests", fileName); // changing to this because I work across MacOS and Windows
                    ...
                    case 5:
                        ...
                        else
                        {
                            ...
                            //Display the shortest distance between all pairs of intersections
